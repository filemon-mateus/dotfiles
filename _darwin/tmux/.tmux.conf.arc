...
set -g @prefix_highlight_prefix_prompt 'Space'
set -g prefix C-space
bind C-space send-prefix
unbind C-b

# Statusbar
set -g status-left '#[fg='$tm_yellow']#(whoami) #[fg='$tm_red' nobold]∴ '
set -g status-right '#{prefix_highlight} #[fg='$tm_red' nobold]∴ #[fg='$tm_gray' nobold]%H:%M #[fg='$tm_red' nobold]∴ #[nobold]#{battery_color_charge_fg}#[bg='$tm_background']#{battery_icon} #{battery_percentage}'
set -g status-position top
set -g status-right-length 0
set -g status-justify left 
set -g status-fg $tm_gray
set -g status-bg $tm_background
...
set -g window-status-current-format '#[fg='$tm_blue']#I:#W*'
