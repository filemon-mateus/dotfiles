...
let s:nord0_gui =         "#12161e"
let s:nord1_gui =         "#1e2736"
let s:nord2_gui =         "#1a2331"
let s:nord3_gui =         "#2a374e"
let s:nord3_gui_bright =  "#2a374e"
let s:nord4_gui =         "#6a8998"
let s:nord5_gui =         "#6a8998"
let s:nord6_gui =         "#6a8998"
let s:nord7_gui =         "#4faba6"
let s:nord8_gui =         "#3bb9c5"
let s:nord9_gui =         "#4c87b4"
let s:nord10_gui =        "#436ea0"
let s:nord11_gui =        "#cc2846"
let s:nord12_gui =        "#d26c58"
let s:nord13_gui =        "#f6b655"
let s:nord14_gui =        "#76af5f"
let s:nord15_gui =        "#ae6698"
...
if exists("g:nord_comment_brightness")
  call s:logWarning(
    \'Variable g:nord_comment_brightness has been deprecated and will be removed in version 1.0.0! ' .
...
call s:hi("NonText", s:nord2_gui, "NONE", s:nord3_term, "", "", "")
...
call s:hi("pythonBrackets", s:nord8_gui, "", s:nord8_term, "", "", "")
call s:hi("pythonDecorator", s:nord12_gui, "", s:nord12_term, "", "", "")
call s:hi("pythonBuiltinObj", s:nord8_gui, "", s:nord8_term, "", "", "")
...
hi! VertSplit guifg=#141d2c guibg=NONE
hi! CursorLine guibg=#10131B
hi! CursorLineNr guibg=#10131B
hi! NonText gui=NONE cterm=NONE guifg=#141d2c
hi! SpellBad gui=UNDERLINE cterm=UNDERLINE guifg=#cc2846 guibg=NONE
hi! SpellCap gui=UNDERLINE cterm=UNDERLINE guifg=#f6b655 guibg=NONE
hi! StatusLine guibg=#226199 guifg=#12161e
hi! StatusLineNC guibg=#0e1219 guifg=#6a8998
hi! MatchParen guibg=#1e2736 guifg=#6a8998
hi! Error guifg=#12161e guibg=#cc2846
hi! ErrorMsg guifg=#12161e guibg=#cc2846
hi! Conceal guibg=#12161e guifg=#6a8998
highlight ColorColumn guibg=#10131B
