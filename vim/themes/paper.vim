...
fun! s:register_default_theme()
  ...
  let s:themes['default'].light = {
        ...
        \       'color16' : ['#0087af', '31'],
        \       'color17' : ['#008700', '28'],
        \       'cursor_fg' : ['#af5f00', '255'],
        \       'cursor_bg' : ['#e6e5e7', '24'],
        \       'cursorline' : ['#e6e5e7', '254'],
        \       'cursorcolumn' : ['#e6e5e7', '254'],
        \       'cursorlinenr_fg' : ['#af5f00', '130'],
        \       'cursorlinenr_bg' : ['#e6e5e7', '255'],
        \       'popupmenu_fg' : ['#444444', '238'],
        \       'popupmenu_bg' : ['#d0d0d0', '252'],
        \       'search_fg' : ['#444444', '238'],
        \       'search_bg' : ['#ffff5f', '227'],
        \       'linenumber_fg' : ['#b2b2b2', '249'],
        \       'linenumber_bg' : ['#e9e8ea', '255'],
        \       'vertsplit_fg' : ['#d4d4d4', '24'],
        \       'vertsplit_bg' : ['#e9e8ea', '255'],
        \       'statusline_active_fg' : ['#e9e8ea', '254'],
        ...
        \       'error_fg' : ['#af0000', '124'],
        \       'error_bg' : ['#ffd7ff', '225'],
        \       'matchparen_bg' : ['#dbdadc', '251'],
        \       'matchparen_fg' : ['#af5f00', '24'],
        \       'visual_fg' : ['#e9e8ea', '255'],
        \       'visual_bg' : ['#0087af', '31'],
        \       'folded_fg' : ['#0087af', '31'],
...
fun! s:set_format_attributes()
  ...
  if s:mode == s:MODE_GUI_COLOR
    ...
    let s:ft_underline = " cterm=underline, gui=underline "
  elseif s:mode == s:MODE_256_COLOR
    ...
    let s:ft_underline = " cterm=underline "
  else
    let s:ft_bold    = ""
    let s:ft_none    = " cterm=none "
    let s:ft_reverse = " cterm=reverse "
...
fun! s:apply_syntax_highlightings()
  ...
  " Git Gutter Hilighting
  exec 'hi GitGutterAdd' . s:fg_green . s:bg_background
  exec 'hi GitGutterChange' . s:fg_orange . s:bg_background
  exec 'hi GitGutterDelete' . s:fg_red . s:bg_background
  ...
  exec 'hi SpellBad' . s:fg_foreground . s:bg_spellbad . s:ft_underline
  exec 'hi SpellCap' . s:fg_foreground . s:bg_spellcap . s:ft_underline
  exec 'hi SpellRare' . s:fg_foreground . s:bg_spellrare . s:ft_underline
  exec 'hi SpellLocal' . s:fg_foreground . s:bg_spelllocal . s:ft_underline

  " Plugin: Multiple Cursors
  exec 'hi multiple_cursors_cursor' . s:fg_foreground
  exec 'hi multiple_cursors_visual' . s:fg_foreground
...
highlight StatusLine cterm=NONE guifg=#e9e8ea guibg=#005f87
