...
set -g status-right '#{prefix_highlight} #[fg='$tm_red' nobold]∴ #[fg='$tm_gray' nobold]%H:%M #[fg='$tm_red' nobold]∴ #[nobold]#{battery_color_charge_fg}#{battery_icon} #{battery_percentage}'
